    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-6 py-8 h-screen flex flex-col">
        ...
        <div className="flex-1 flex flex-col lg:flex-row gap-4 max-h-[calc(100vh-200px)]">
          ...
          {/* Aionara's Video - Clean Side Panel */}
          <motion.div
            className="w-full lg:w-80 flex flex-col items-center justify-start bg-black/20 backdrop-blur-sm border border-silver-star/20 rounded-xl p-6"
          ...
          >
            ...
            <div className="mt-6 text-center">
              <h3 className="font-gothic text-xl text-golden-rune mb-2 flex items-center justify-center gap-2">
